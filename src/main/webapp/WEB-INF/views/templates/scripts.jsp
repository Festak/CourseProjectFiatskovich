...
<script src="${contextPath}/resources/angular/main.js"></script>
<script src="${contextPath}/resources/angular/product.js"></script>
...
<!-- animation-effect -->
<link href="${contextPath}/resources/css/template/animate.min.css" rel="stylesheet">
<script src="${contextPath}/resources/js/wow.min.js"></script>
<script src="${contextPath}/resources/js/memenu.js"></script>
<script>
    new WOW().init();
</script>